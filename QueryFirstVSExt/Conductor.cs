...
See the Readme section at https://marketplace.visualstudio.com/items?itemName=bbsimonbb.QueryFirstVSExt    
");
...
The query {1} may not run and the wrapper has not been regenerated.\n",
                ...
                _vsOutputWindow.Write("QueryFirstVSExt generated wrapper class for " + _state._1BaseName + ".sql" + Environment.NewLine);
