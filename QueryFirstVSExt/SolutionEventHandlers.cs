...
@"If you're using and enjoying QueryFirstVSExt, please leave a review!
https://marketplace.visualstudio.com/items?itemName=bbsimonbb.QueryFirstVSExt#review-details
"
                );
                spammed = true;
            }
        ...
        private void connectEditorWindow2DB(Document Document)
        {
            try
            {
                ...
                if (Document.FullName.EndsWith(".sql"))
                {
                    ...
                    if (text.Contains("managed by QueryFirstVSExt"))
                    {
